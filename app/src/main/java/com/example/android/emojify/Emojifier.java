...
class Emojifier {
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture) {
        ...
        d("detectFaces: number of faces = " + faces.size());
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        d("whichEmoji: smilingProb = " + face.getIsSmilingProbability());
        d("whichEmoji: leftEyeOpenProb = "
                + face.getIsLeftEyeOpenProbability());
        d("whichEmoji: rightEyeOpenProb = "
